  ...
  return (
    <div className="min-h-screen min-w-screen flex justify-center items-center bg-[url(/mena/white.jpg)]">
      <audio ref={audioRef} loop>
        <source src="/mena/bad.mp3" type="audio/mp3" />
      </audio>
      {isOpen ? (
        ...
        <div className="text-center flex flex-col items-center">
          ...
          <button
            onClick={openHandler}
            className="cursor-pointer hover:animate-bounce  text-white bg-black rounded-full w-16 h-16 mt-5 flex items-center justify-center"
          >
            <svg
    ...
    <>
      <div>
        <div>
          <Image
            ...
            className={`absolute transition-all duration-700 ${
              parts === 2
                ? "bottom-50 left-50 rotate-20 opacity-100"
                : "-bottom-50 -left-50 rotate-0 opacity-0"
            }`}
          />
          <Image
            src={"/mena/w2elogo.png"}
            width={300}
            height={300}
            alt="w2e"
            className={`absolute transition-all duration-700 ${
              parts === 2
                ? "bottom-50 right-50 -rotate-20 opacity-100"
                : "-bottom-50 -right-50 rotate-0 opacity-0"
            }`}
          />
          <Image
            src={"/mena/w2emember.png"}
            width={400}
            height={400}
            alt="w2e"
            className={`absolute transition-all duration-700 ${
              parts === 2
                ? "top-20 right-50 rotate-20 opacity-100"
                : "-top-50 -right-50 rotate-0 opacity-0"
            }`}
          />
        </div>
        <div>
          <Image
            src={"/mena/dimsum1.png"}
            width={300}
            height={300}
            alt="dimsum"
            className={`absolute transition-all duration-700 ${
          ...
          />
          <Image
            src={"/mena/dimsum3.png"}
            width={400}
            height={400}
            alt="dimsum"
            className={`absolute transition-all duration-700 ${
              parts === 3
                ? "top-0 right-50 rotate-20 opacity-100"
                : "-top-50 -right-50 rotate-0 opacity-0"
            }`}
          />
        </div>
        <div>
          ...
          />
          <Image
            src={"/mena/roblox2.png"}
            width={400}
            height={400}
            alt="roblox"
            className={`absolute transition-all duration-700 ${
              parts === 4
                ? "top-10 left-20 -rotate-20 opacity-100"
                : "-top-50 -left-50 rotate-0 opacity-0"
            }`}
          />
        </div>
        <div>
          ...
          <Image
            ...
            height={500}
            alt="bunga"
            className={`absolute transition-all duration-700 rotate-y-180 ${
              parts === 5
                ? "bottom-0 right-0 opacity-100"
                : "-bottom-50 -right-50 rotate-0 opacity-0"
            }`}
          />
        </div>
        <div
          className={`absolute transition-all duration-700 top-0 left-0 w-full ${
            parts >= 6 ? (isFinish ? "opacity-100" : "opacity-30") : "opacity-0"
          }`}
        >
          <Marquee className="">
      ...
      <div>
        ...
        {parts === 10 && (
          <div
            className={`transition-all ${
              parts === 10 ? "opacity-100" : "opacity-0"
            }`}
          >
            <TextGenerateEffect
              isStart={steps === 12}
        ...
        {parts === 11 && (
          <div
            className={`transition-all ${
              parts === 11 ? "opacity-100" : "opacity-0"
            }`}
          >
            <TextGenerateEffect
              isStart={steps === 13}
        ...
        {parts === 12 && (
          <div
            className={`transition-all ${
              parts === 12 ? "opacity-100" : "opacity-0"
            }`}
          >
            <TextGenerateEffect
              isStart={steps === 14}
        ...
        {parts === 13 && (
          <div
            className={`transition-all ${
              parts === 13 ? "opacity-100" : "opacity-0"
            }`}
          >
            <TextGenerateEffect
              isStart={steps === 15}
        ...
        {parts === 14 && (
          <div
            className={`transition-all ${
              parts === 14 ? "opacity-100" : "opacity-0"
            }`}
          >
            <TextGenerateEffect
              isStart={steps === 16}
        ...
        {parts === 15 && (
          <div
            className={`transition-all ${
              parts === 15 ? "opacity-100" : "opacity-0"
            }`}
          >
            <TextGenerateEffect
              isStart={steps === 17}
        ...
        {parts === 16 && (
          <div
            className={`transition-all ${
              parts === 16 ? "opacity-100" : "opacity-0"
            }`}
          >
            <TextGenerateEffect
              isStart={steps === 18}
        ...
        {parts === 17 && (
          <div
            className={`transition-all ${
              parts === 17 ? "opacity-100" : "opacity-0"
            }`}
          >
            <TextGenerateEffect
              isStart={steps === 19}
...
const PhotoCard = (props: {
  ...
  return (
    <div className={`w-[350px] h-[350px] bg-red-500 ${className}`}>
      {type === "image" ? (
        <Image
          src={src}
          width={350}
